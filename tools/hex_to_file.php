...
<div id="main">
<h1>十六进制 -> 文件 （二进制文件）</h1>
      <p>从十六进制代码（javascript，仅限客户端）创建任意文件。使用PaleMoon 25.2.1和Chromium 46进行测试。
	  </p>
      ...
      <br>
      <p>
     对于较大的（超过几MB）<a href="http://tomeko.net/bin/hex_to_file/hex_to_file.exe">hex_to_file.exe</a> 可能更有用。
      <br>
     另一个较旧的控制台应用程序：<a href="http://tomeko.net/bin/hex2bin/hex2bin.zip">hex2bin.zip</a>.
      </p> 
<div>
